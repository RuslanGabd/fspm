...
import org.ruslan.user.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.GET, "/product/**").permitAll()//hasAnyRole("USER", "ADMIN")////
                        .requestMatchers(HttpMethod.GET, "/pps/**").permitAll()
